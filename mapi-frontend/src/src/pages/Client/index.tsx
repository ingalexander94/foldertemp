...
const EditEquipment = lazy(() => import("./CustomerEquipment/EditEquipment"));
      ...
      <Suspense fallback={<Loading />}>
        ...
        <div className={styles.wrapper__private}>
          <RoutesWithNotFound validateAuth={false}>
            ...
            />
            <Route
              path={`${privateRoutes.EQUIPMENT}/${privateRoutes.EDITEQUIPMENT}`}
              element={<EditEquipment />}
            />
            <Route
              path={`${privateRoutes.EQUIPMENT}/${privateRoutes.DETAILEQUIPMENT}`}
              element={<Detail />}
            />
