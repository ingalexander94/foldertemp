...
# Tiempo de generación: 2024-03-11 21:50:44 +0000
# ************************************************************
...
VALUES
	(10,'1M','MOTOR',12,1,'2024-02-29 19:10:42'),
	(11,'2OE','ELECTRICIDAD',12,1,'2024-02-29 19:11:18');
...
VALUES
	...
	(2,'Filtro separador ISXPP','FF3699W',100,278,NULL,NULL,NULL,'2024-02-29 19:09:38','2024-03-05 20:40:34'),
	(4,'Filtro combustible 10 Micras','TLL1',1,5,NULL,NULL,NULL,'2024-03-05 20:38:39',NULL);
...
CREATE TABLE `mp_operations` (
  ...
  `operation_duration` varchar(20) DEFAULT NULL,
...
INSERT INTO `mp_operations` (`id_operation`, `operation_team`, `operation_component`, `operation_measure`, `operation_description`, `operation_technician`, `operation_duration`, `operation_maintenance_type`, `operation_total`, `operation_state`, `operation_created_at`, `operation_kilometres`, `operation_hours`, `operation_duration_minutes`, `operation_duration_hours`)
VALUES
	(7,12,'C-10',2,'Cambiar las tapas del motor.',2,'00:17:00',1,10000,1,'2024-02-29 19:19:15',2000,600,NULL,NULL),
	(8,12,'C-10',1,'Mensaje de prueba',NULL,NULL,NULL,NULL,1,'2024-02-29 19:28:26',NULL,NULL,NULL,NULL);
...
VALUES
	(2,'Alexander','Peñaloza','+573213568479','1090494143','mapi/avatars/default.svg',3,1000000,1,'2024-03-07 15:40:35'),
	(3,'Mónica','Sanchez','+573213568479','1090494143','mapi/avatars/default.svg',2,1000000,1,'2024-03-07 15:40:35');
...
VALUES
	(1,1,12,9,11,2020,'WOY52C','MOTOS','2024-03-11 13:13:58',1,'3WKDD40XXMF728346',2,NULL,NULL,NULL,NULL,NULL,NULL,1,'2024-03-11 12:57:38'),
	(2,1,12,9,11,2020,'MSI125','MOTOS','2024-03-11 13:13:58',1,'3WKDD40XXMF728346',2,NULL,NULL,NULL,NULL,NULL,NULL,1,'2024-03-11 12:57:38');
